...
describe('LoginGuardService', () => {
  ...
  it('checkIfComponentCanActivate should return false if user not logged in and guarding not disabled', () => {
  ...
  it('checkIfComponentCanActivate should return true if user is logged in and guarding is not disabled', () => {
    let originalValue = environment.routeGuardingDisabled;
    environment.routeGuardingDisabled = false;
    userServiceSpy.isLoggedIn.and.returnValue(true);
